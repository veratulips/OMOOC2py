...
@route('/new',method='GET') # get input from webpage
def new_item():
...
# you'd better not to use reload here because this could cause a problem. 
# see trouble shooting part on README.md 
